 ...
 * Task
 *
 * Variables named 'firstInteger', 'firstDecimal', and 'firstString' are
 * declared for you in the editor below. You must use the '+' operator to
 ...
 *       sum it with 'firstDecimal' and print the result on a new line using
 *       'console.log'.
 *
 *   3.- Print the concatenation of 'firstString' and 'secondString' on a new
 *       line using 'console.log'. Note that 'firstString' must be printed
 *       first.
 *
 * Input Format
 *
 * Data Type |   Parameter   |                   Description
 *   string  | secondInteger | The string representation of an integer you must
 *           |               | sum with 'firstInteger'.
 *           |               |
 *   string  | secondDecimal | The string representation of a floating-point
 *           |               | number you must sum with 'firstDecimal'.
 *           |               |
 *   string  | secondString  | A string of one or more space-separated words you
 *           |               | must append to 'secondString'.
 *
 * Output Format
 *
 ...
 * When we concatenate "HackerRank" with "is the best place to learn and
 * practice coding!", we get "HackerRank is the best place to learn and practice
 * coding!".
 *
