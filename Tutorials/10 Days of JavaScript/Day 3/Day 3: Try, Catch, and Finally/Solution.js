 ...
 *       be the reversed string; if an exception was thrown, this should be the
 *       original string.
 *
 * Input Format
 *
 ...
 *
 *   1.- Print the contents of a caught exception's 'message' on a new line. If
 *       no exception was thrown, this line should not be printed.
 *
 *   2.- Print 's' on a new line. If no exception was thrown, then this should
 *       be the reversed string; if an exception was thrown, this should be the
 *       original string.
 *
 * Sample Input 0
