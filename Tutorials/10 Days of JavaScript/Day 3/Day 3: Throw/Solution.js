 ...
 *
 *   2.- 'isPositive(0)': Because 'a = 0', we throw an 'Error' with
 *       'message = Zero Error'. This is caught by the locked stub code and the
 *       value of its 'message' is printed.
 *
 ...
 * 'isPositive' function:
 *
 *   1.- 'isPositive(-1)': Because 'a = -1', we throw an 'Error' with
 *       'message = Negative Error'. This is caught by the locked stub code and
 *       the value of its 'message' is printed.
 *
 *   3.- 'isPositive(20)': This returns 'YES' because '20' is positive.
 */
