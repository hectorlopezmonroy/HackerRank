 ...
 *      type String.
 *
 *   2. Read 3 line of input from stdin (according to the sequence given in the
 ...
 * concatenation (eg: C), you can just print one variable immediately following
 * the other on the same line. The string provided in your editor must be
...
public class DataTypes {
    public static void main(String[] args) {
         ...
         * Note: If youhave trouble reading the entire String, please go back
