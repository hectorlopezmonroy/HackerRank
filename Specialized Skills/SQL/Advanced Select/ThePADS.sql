 ...
 *       parenthical (i.e.: enclosed in parentheses). For example:
 ...
 * names corresponding to each profession (2 <= 2 <= 3 <= 3), and then
 * alphabetically by profession (doctor <= singer, and actor <= professor).
 */
