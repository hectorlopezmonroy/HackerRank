 ...
 * 's' is defined as 'char s[MAX_LEN]' where 'MAX_LEN' is the maximum size of
 * 's'. Here, [] is the scanset character. '^\n' stands for taking input until a
 ...
 * the above mentioned statement won't work. This is because, at the end of each
 * line, a new line character (\n) is present. So, the statement:
 * 'scanf("%[^\n]%*c", s)'; will not work because the last statement will read a
 * newline character from the previous line. This can be handled in a variety of
 * ways and one of them being: 'scanf("\n")'; before the last statement.
 *
 * Task
 *
