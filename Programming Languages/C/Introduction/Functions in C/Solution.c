 ...
 * Objective
 *
 * In this challenge, you will learn simple usage of functions in C. Functions
 * are a bunch of statements glued together. A function is provided with zero or
 * more arguments, and it executes the statements on it. Based on the return
 ...
 * which receives four arguments and returns the greatest of them.
 *
 * Input Format
 *
