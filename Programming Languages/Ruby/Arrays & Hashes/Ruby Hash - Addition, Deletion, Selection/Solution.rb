...
#   >> h.delete(key)
#
# * For destructive selection and deletion, we can use 'keep_if' and 'delete_if'
#   as seen in Array-Selection.
#
...
#
# In this challenge, a hash object called 'hackerrank' is already created.
#
# You have to add:
#
