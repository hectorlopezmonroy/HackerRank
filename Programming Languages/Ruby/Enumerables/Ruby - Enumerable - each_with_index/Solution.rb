...
# of the methods provided by 'Enumerable' class.
#
# One of such useful methods is 'each_with_index' which allows you to iterate
# over items along with an index keeping count of the item.
#
# For example,
#
...
# takes an 'animals' array and a 'skip' integer and returns an array of all
