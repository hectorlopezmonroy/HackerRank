...
#   separator removed from the end of the string (if present). If '$/' has not
#   been changed from the default Ruby record separator, then chomp also removes
...
#     => "hello \n there"
#
# * 'String.strip': Returns a new string with the leading and trailing
#   whitespace removed.
#
#     >> "    hello    ".strip
#     => "hello"
...
#     => "goodbye"
#
# * 'String.chop': Returns a new string with the last character removed. Note
#   that carriage returns (\n, \r\n) are treated as a single character and, in
#   the case they are not present, a character from the string 'will be
#   removed'.
#
#     >> "string\n".chop
#     => "string"
