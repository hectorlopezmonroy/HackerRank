...
# participates in a contest we update their score once the contest ends. You
# will be given a method called 'scoring' with an array passed as an argument.
# Elements of the array are of the class 'User'.
#
