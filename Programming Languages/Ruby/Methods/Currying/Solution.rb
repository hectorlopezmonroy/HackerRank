# 'Currying' is a technique in which a function accepts 'n' parameters and turns
# it into a sequence of 'n' functions, where each of them take '1' parameter.
#
# Example:
#
...
#   puts tripler.(4)    # 12
#
# In the above example, lambda take two parameters 'x', 'y' and return the
# product of the two.
#
