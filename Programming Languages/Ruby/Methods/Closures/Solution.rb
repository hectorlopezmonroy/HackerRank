...
#   It can be treated like a variable, which can be assigned to another
#   variable, passed as an argument to a method.
#
...
#   function was defined. It is then able to access those variables when it is
#   called even if they are in a different scope.
#
# Example:
#
#   def plus_1(y)
