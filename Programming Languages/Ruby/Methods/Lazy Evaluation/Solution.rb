...
#
# If we remove 'lazy' from the code above, then our code would try to compute
# all 'x' ranging from '1' to 'Float::INFINITY'.
#
# To avoid timeouts and memory allocation exceptions, we use 'lazy'. Now, our
# code will only compute up to 'first(array_size)'.
#
# Task
#
# Your task is to print an array of the first 'N' palindromic prime numbers.
#
# For example, the first '10' palindromic prime numbers are '[2, 3, 5, 7, 11,
# 101, 131, 151, 181, 191]'.
#
# Input Format
#
