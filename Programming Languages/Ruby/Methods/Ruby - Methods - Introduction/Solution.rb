...
# In this set of challenges, we will explore the guiding principles behind
# methods, learn more features and how to use them efficiently in our programs.
#
...
# functions, are instead private methods of a roof 'Object' class on which they
...
# Further Reading
#
# These methods, unlike functions in other object oriented programming languages
