# In 'Partial Application', we create a lambda that takes a parameter and
# returns a lambda that does something with it.
#
# Example:
#
...
#   1.- https://en.wikipedia.org/wiki/Combination#Example_of_counting_combinations
#   2.- https://www.hackerrank.com/challenges/ruby-partial-applications/forum
