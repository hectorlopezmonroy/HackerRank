...
# asked her student Mickey to compute the average of all the plants with
...
# Explanation
#
# Here, set([154, 161, 167, 170, 171, 174, 176, 182]) is the set containing the
# distinct heights. Using the sum() and len() functions, we can compute the
# average.
#
