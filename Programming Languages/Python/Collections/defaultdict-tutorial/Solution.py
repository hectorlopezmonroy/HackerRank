...
# yet. If you didn't use a defaultdict you'd have to check if that key exists,
...
# group 'A' or not. Print the indices of each occurrence of 'm' in group 'A'.
# If it does not appear, print '-1'.
#
# Example
#
# Group A contains 'a', 'b', 'a'. Group B contains 'a', 'c'.
# For the first word in group B, 'a', it appears at positions '1' and '3' in
# group A. The second word, 'c', does not appear in group A, so print '-1'.
#
# Expected Output:
#
# 1 3
...
#
# Output 'm' lines.
# The 'i-th' line should contain the '1'-indexed positions of the occurrences of
# the 'i-th' word separated by spaces.
#
# Sample Input
#
# STDIN Function
