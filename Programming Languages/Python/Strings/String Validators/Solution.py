...
# digits, etc.
#
#   str.isalnum(): This method checks if all the characters of a string are
...
#   False
#
#   str.isalpha(): This method checks if all the characters of a string are
...
#   False
#
#   str.isdigit(): This method checks if all the characters of a string are
#                  digits (0-9).
#
#   >>> print('1234'.isdigit())
#   True
...
#   False
#
#   str.islower(): This method checks if all the characters of a string are
...
#   False
#
#   str.isupper(): This method checks if all the characters of a string are
...
if __name__ == '__main__':
    ...
    for i in range(0, len(s)):
        if not hasAlnum and s[i].isalnum():
            hasAlnum = True
        if not hasAlpha and s[i].isalpha():
            hasAlpha = True
        if not hasDigit and s[i].isdigit():
            hasDigit = True
        if not hasLower and s[i].islower():
            hasLower = True
        if not hasUpper and s[i].isupper():
            hasUpper = True
