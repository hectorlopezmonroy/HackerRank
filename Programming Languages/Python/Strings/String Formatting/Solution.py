...
# for each 'i' from '1' to 'n'. Each value should be space-padded to match the
# width of the binary value of 'n'.
#
# Input Format
#
...
def print_formatted(number):
    ...
    for i in range(1, n + 1):
        print(str(i).rjust(padding), oct(i)[2:].rjust(padding),
              hex(i)[2:].upper().rjust(padding), bin(i)[2:].rjust(padding))
