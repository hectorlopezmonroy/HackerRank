...
# lines contains the name and marks obtained by that student separate by a
...
if __name__ == '__main__':
    ...
    # Process input and populates the dictionary. Finally it process the name of
    # the student to be queried.
    for _ in range(n):
    ...
    # Sums all marks for the student and divide by the number of marks to
