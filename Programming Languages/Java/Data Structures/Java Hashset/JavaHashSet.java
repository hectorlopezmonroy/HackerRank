 ...
 * '{1, 2, 3}' is an example of a set, but '{1, 2, 2}' is not a set. Today you
 * will learn how to use sets in Java by solving this problem.
 *
 * You are given 'n' pairs of strings. Two pairs '(a, b)' and '(c, d)' are
 * identical if 'a = c' and 'b = d'. That also implies '(a, b)' is 'not' same as
 * '(b, a)'. After taking each pair as input, you need to print the number of
 ...
 * Output Format
 *
 * Print 'T' lines. In the 'i-th' line, print the number of unique pairs you
 * have after taking the 'i-th' pair as input.
 *
 * Sample Input
 *
 * 5
