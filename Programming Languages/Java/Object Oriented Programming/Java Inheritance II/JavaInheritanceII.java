 ...
 * Output Format
 *
 * You are not responsible for printing anything to stdout. Your 'add' method
 * must return the sum of its parameters.
 *
 * Sample Output
 *
 * The 'main' method in the 'JavaInheritanceII' class below should print the
 * following:
 *
