 ...
 *
 *   * The username consists of '8' to '30' characters inclusive. If the
 *     username consists of less than '8' or greater than '30' characters, then
 ...
 *     'lowercase' characters '[a-z]', 'uppercase' characters '[A-Z]', and
 *     digits '[0-9]'.
 *
 *   * The 'first' character of the username must be an 'alphabetic' character,
 *     i.e., either 'lowercase' character '[a-z]' or 'uppercase' character
 *     '[A-Z]'.
 *
 * For example:
 *
