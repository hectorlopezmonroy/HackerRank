 ...
 * automate the rounding process. For each grade_i, round it according to the
 * rules above and print the result on a new line.
 *
 * Input Format
 *
 * The first line contains a single integer denoting n (the number of students).
 * Each line i of the n subsequent lines contains a single integer, grade_i,
 ...
 *  4 |       33       |      33
 *
 * 1. Student 1 received a 73, and the next multiple of 5 from 73 is 75. Since
 * 75 - 73 < 3, the student's grade is rounded to 75.
 *
 * 2. Student 2 received a 67, and the next multiple of 5 from 67 is 70. Since
 * 70 - 67 = 3, the grade will not be modified and the student's final grade is
 * 67.
 *
 * 3. Student 3 received a 38, and the next multiple of 5 from 38 is 40. Since
 * 40 - 38 < 3, the student's grade will be rounded to 40.
 *
 * 4. Student 4 received a grade below 38, so the grade will no be modified and
 * the student's final grade is 33.
 */
