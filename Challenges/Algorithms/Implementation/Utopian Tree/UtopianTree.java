 ...
 *
 * In the third case (N = 4), the tree doubles in height in spring (H = 2), then
 * grows a meter in summer (H = 3), then doubles after the next spring (H = 6),
 * and grows another meter after summer (H = 7). Thus, at the end of 4 cycles,
...
class UtopianTree {
    ...
    public static void Solution() {
        ...
        for (int x: testCases) {
            System.out.println(resultsTable[x]);
        }
    }
