 ...
 *
 *   * Firstly, sequentially concatenate the date, month and year, into a new
 *     integer 'x' erasing the leading zeroes.
 *
 *   * Now if 'x' is divisible by either '4' or '7', then we call the date a
 *     lucky date.
 *
 * For example, let's take the date "02-08-2024". After concatenating the day,
 ...
 * dates following the format dd-mm-yyyy. Consider, 'd' is the day number, 'm'
 * is the month number and 'y' is the year number.
 *
 * Note: Here 'm = 01' means January, 'm = 02' means February, 'm = 03' means
 * March and so on and all the dates follow the standard structure of English
 * calendar including the leap year.
 *
 * Constraints
 *
 * 1 <= d1, d2 <= 31
 ...
 * Output Format
 *
 * Print a single integer, the number of lucky dates between 'u' and 'v' in a
 * single line.
 *
 * Sample Input
 *
