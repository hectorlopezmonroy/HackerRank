 ...
 *
 * Complete the function 'compareTriplets' in the editor below. It must return
 * an array of two integers, the first being Alice's score and the second being
 * Bob's.
 *
 ...
 *
 * Comparing the 1st and 2nd elements, 28 > 16 and 30 > 8 so Alice receives two
 * points.
 *
...
public class CompareTheTriplets {
    ...
    /** Compares two challenges' ratings, returns their comparison points.
     * It returns an array of two integers, the first being Alice's score and
     * the second being Bob's.
     * @param a an integer array representing Alice's challenge score.
     * @param b an integer array representing Bob's challenge score.
     * @return an array of integers denoting the respective comparison points.
     */
